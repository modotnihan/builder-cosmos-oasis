          ...
          >
            ...
            >
              ...
              >
                ...
                <div
                  style={{
                    ...
                    background:
                      "linear-gradient(143deg, #4AA8FF 0%, #7BDBA7 100%)",
                    display: "flex",
                    alignItems: "center",
              ...
              >
                ...
                >
                  <label style={{ fontSize: "0.75rem", color: "#8EA0B5" }}>
                    Date
                  </label>
                  <input
                    type="text"
                ...
                <div
                  style={{ display: "flex", alignItems: "end", gap: "0.75rem" }}
                >
                  {/* Flight Input */}
                  <div
                    style={{
            ...
            >
              ...
              >
                ...
                >
                  <Link to="/tag-scan" style={{ textDecoration: "none" }}>
                    <button
                      style={{
                        ...
                        background:
                          "linear-gradient(180deg, #2A84DF 0%, #206DB9 100%)",
                        color: "#E7EEF7",
                        fontSize: "1rem",
                        fontWeight: "bold",
                        cursor: "pointer",
                  ...
                  >
                    <span style={{ fontSize: "1rem", color: "#8EA0B5" }}>
                      HID
                    </span>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <div style={{ fontSize: "0.75rem", color: "#8EA0B5" }}>
                      Tags Saved
                    </div>
                  </div>
                  <div
